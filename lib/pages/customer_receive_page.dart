...
class CustomerReceivePage extends StatelessWidget {
  CustomerReceivePage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider<CustomerReceivePageProvider>(
      create: (context) => CustomerReceivePageProvider(),
      child: Consumer<CustomerReceivePageProvider>(
              ...
              body: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        SizedBox(height: 100,width: 200,child: DropDownWidget(optionName: 'Customer Name', clr: false),),
                        SizedBox(
                          height: 100,
                          width: 200,
