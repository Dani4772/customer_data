...
class CustomerList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<CustomerListPageProvider>(create: (context)=>CustomerListPageProvider(),
    child: Consumer<CustomerListPageProvider>(builder: (context,provider,child){
      return  Scaffold(
