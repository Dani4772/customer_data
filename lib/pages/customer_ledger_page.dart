...
class CustomerLedgerPage extends StatelessWidget {
  CustomerLedgerPage({Key? key}) : super(key: key);
  String _toSelectedDate = 'October 12,2019';
  String _fromSelectedDate = 'October 12,2019';
  String? choosenValue;
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<CustomerLedgerPageProvider>(
      create: (context) => CustomerLedgerPageProvider(),
      child: Consumer<CustomerLedgerPageProvider>(
                          ...
                          rows: const [
                            DataRow(cells: [
                              ...
                              DataCell(SizedBox(
                                  ...
                                  width: 120,
                                  child: Text(
                                    'Customer Debit For Invoice No 1019 customer-Adnan Ameen',
                                    maxLines: 10,
                                    textAlign: TextAlign.center,
                                  ))),
